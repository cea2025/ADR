const CACHE_NAME = 'adr-calculator-v1';
const STATIC_CACHE = 'adr-static-v1';
const DYNAMIC_CACHE = 'adr-dynamic-v1';
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('ADR Calculator', options)
  );
});
